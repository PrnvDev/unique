...
<div class="woocommerce-order">
	...
	if ( $order ) :
		...
		if ($thegem_checkout_thanks_template && defined('ELEMENTOR_VERSION')) :
			...
			echo \Elementor\Plugin::instance()->frontend->get_builder_content_for_display($thegem_checkout_thanks_template);
			echo '</div>';
