...
return array(
    ...
    'info' => array (
        ...
        'layout_header_sticky' => __('<p>Enable/disable sticky header for desktop/mobile. By enabling sticky header you can then select the header template to be used as sticky header and specify sticky header opacity. Alternatively, you can make sticky header by enabling "sticky" option in a section (Elementor). <br/><br/> Additionally you can enable <b>"Hide On Scroll"</b> sticky effect. If enabled, the sticky header will first appear and then disappear by scrolling down. It will appear again by scrolling up.  </p>', 'thegem'),
        ...
        'single_pages_post_default_php_template' => __('Specify the default layout template to use globally across your posts. You can optionally override this global setting for separate posts in "Template" metabox of the respective posts separately.', 'thegem'),
        ...
        'single_pages_post_custom_default_php_template' => __('Specify the default layout template to use globally across your CPTs. You can optionally override this global setting for separate CPTs in "Template" metabox of the respective CPTs separately.', 'thegem'),
        ...
        'single_pages_page_default_php_template' => __('Specify the default layout template to use globally across your pages. You can optionally override this global setting for separate pages in "Template" metabox of the respective pages separately.', 'thegem'),
        ...
        'single_pages_portfolio_default_php_template' => __('Specify the default layout template to use globally across your portfolio pages. You can optionally override this global setting for separate portfolio pages in "Template" metabox of the respective portfolio pages separately.', 'thegem'),
        ...
        'performance_page_speed_woocommerce_order_attribution_feature_enabled' => __('Since version 8.5.x, WooCommerce has introduced a new feature called "Order Attribution". If enabled, this feature loads many additional JS and CSS files due to block editor dependencies. The loading of these additional JS and CSS files can negatively impact website performance. If you don\'t use the "Order Attribution" feature in WooCommerce, we recommend disabling it.', 'thegem'),
        ...
        'extras_e_image_loading_optimization_feature' => __('<p>Note: at the moment you have activated TheGem\'s "JS Lazy Loading" feature for optimizing image loading performance. TheGem\'s "JS Lazy Loading" feature and "Optimize Image Loading" feature of Elementor cannot work at the same time. If you wish to use Elementor\'s "Optimize Image Loading", please deactivate TheGem\'s "JS Lazy Loading" or switch to the "Native Lazy Loading" under "Theme Options -> Performance -> Page Speed -> Image Loading Optimizations"</p>', 'thegem'),
        'extras_elementor_container_layout_disabled' => __('<p>If enabled, the "Default Paddings" feature is added to Elementor containers for maximizing compatibility with default TheGem paddings and gaps used for sections and columns in previous Elementor versions. <a href="https://docs.codex-themes.com/article/700-flexbox-containers-new" target="_blank">Read More</a></p>', 'thegem'),
        ...
        'p_options_page_as_onepager_new' => __('<p>If enabled, your page can be set as onepager. Check details in this video tutorial <a href="https://youtu.be/wrpX7OfImFc" target="_blank">https://youtu.be/wrpX7OfImFc</a> and in <a href="https://docs.codex-themes.com/article/444-one-page-website-thegem-elementor" target="_blank">documentation</a></p>', 'thegem'),
        'p_options_page_as_fullpage_scroller_new' => __('<p>If enabled, your page can be set as fullpage vertical scroller. Check details in this video tutorial <a href="https://youtu.be/FWwoG00JVuA" target="_blank">https://youtu.be/FWwoG00JVuA</a> and in <a href="https://docs.codex-themes.com/article/447-thegem-elementor" target="_blank">documentation</a></p>', 'thegem'),
    ...
    'menu' => array(
        ...
        'performance_content-widgets' => __('Content Elements', 'thegem'),
    ...
    'extras' => array(
        ...
        'thegem_defaults' => __('TheGem Defaults', 'thegem'),
        'elementor_defaults' => __('Elementor Defaults', 'thegem'),
    ),
    'colorpicker' => array(
        'undo' => __('Undo', 'thegem')
    ),
    'panel' => array(
        ...
        'woocommerce_order_attribution_feature_enabled' => __('Disable WooCommerce Order Attribution Feature', 'thegem'),
        ...
        'e_image_loading_optimization_feature' => __('Elementor`s Optimize Image Loading Feature', 'thegem'),
        'elementor_container_layout_disabled' => __('Container "Default Paddings" Feature in Elementor', 'thegem'),
        'elementor_container_layout_defaults' => __('Default Value', 'thegem'),
        ...
        'post_default_php_template' => __('Default PHP Template', 'thegem'),
        ...
        'page_default_php_template' => __('Default PHP Template', 'thegem'),
        ...
        'portfolio_project_details' => __('Project Details', 'thegem'),
        'portfolio_default_php_template' => __('Default PHP Template', 'thegem'),
        ...
        'content_widgets' => __('TheGem Content Widgets', 'thegem'),
        'content_widgets_all_triggers' => __('Enable/Disable All Widgets', 'thegem'),
        'content_widgets_widgets' => __('Widgets', 'thegem'),
    ),
    'settings' => array(
    ...
    'alert' => array(
        ...
        'content_widgets_info_text' => __('Below is the complete list of TheGem\'s 100+ Elementor content widgets. Streamline your Elementor interface by deactivating unused widgets, providing a more focused and enhanced editing experience with improved performance. Remember to save your changes. <b>Note:</b> Disabling widgets here will eliminate them from both the Elementor and your website, potentially influencing your overall layout, design, and visitor experience.', 'thegem'),
        'product_page_ajax_add_to_cart' => __('NOTE: this setting will not work in case the "Redirect to the cart page after successful addition" setting is activated in', 'thegem'),
        'product_page_ajax_add_to_cart_link' => __('WooCommerce -> Settings -> Products -> General', 'thegem'),
    ),
    'filesystem' => array(
    ...
    'optimizer' => array(
        ...
        'alert' => '<p>Caching plugin is not found. Please <a href="https://codex-themes.com/thegem/thegem-wp-rocket.php" target="_blank">install & activate caching plugin</a> to enable one-click optimization feature. <a href="https://docs.codex-themes.com/article/280-one-click-optimization" target="_blank">Learn more</a></p>',
    ...
    'postLayout' => array(
        ...
        'post_php_template_boxed' => __('TheGem Boxed', 'thegem'),
        'post_php_template_fullwidth' => __('TheGem Full Width', 'thegem'),
    ),
    'searchLayout' => array(
        'type_default' => __('Default Masonry (Legacy)', 'thegem'),
