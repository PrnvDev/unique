...
<?php if(thegem_get_option('counter_thin_font_family')) : ?>
.gem-counter-number.thin-font {
	font-family: '<?php echo thegem_get_option('counter_thin_font_family'); ?>';
}
<?php endif; ?>

<?php if(thegem_get_option('counter_thin_font_style')) : ?>
.gem-counter-number.thin-font {
	font-style: normal;
	font-weight: <?php echo str_replace(array('italic', 'normal', 'regular', 'oblique'),array('', '', 'normal', ''),thegem_get_option('counter_thin_font_style')); ?>;
}
<?php if(strpos(thegem_get_option('counter_thin_font_style'), 'italic') !== false) : ?>
.gem-counter-number.thin-font {
	font-style: italic;
}
<?php endif; ?>
<?php if(strpos(thegem_get_option('counter_thin_font_style'), 'oblique') !== false) : ?>
.gem-counter-number.thin-font {
	font-style: oblique;
}
<?php endif; ?>
...
<?php if(thegem_get_option('counter_thin_font_size')) : ?>
.gem-counter-number.thin-font {
	font-size: <?php echo thegem_get_option('counter_thin_font_size'); ?>px;
}
<?php endif; ?>

<?php if(thegem_get_option('counter_thin_line_height')) : ?>
.gem-counter-number.thin-font {
	line-height: <?php echo thegem_get_option('counter_thin_line_height'); ?>px;
}
<?php endif; ?>

<?php if(thegem_get_option('counter_thin_text_transform')) : ?>
.gem-counter-number.thin-font {
	text-transform: <?php echo thegem_get_option('counter_thin_text_transform'); ?>;
}
<?php endif; ?>

<?php if(thegem_get_option('counter_thin_letter_spacing') !== '') : ?>
.gem-counter-number.thin-font {
	letter-spacing: <?php echo strval(thegem_get_option('counter_thin_letter_spacing')); ?>px;
}
<?php endif; ?>

<?php if(thegem_get_option('counter_thin_custom_responsive_fonts')) : ?>
<?php if(thegem_get_option('counter_thin_font_size_tablet')) : ?>
@media (max-width: 1199px) {
	.gem-counter-number.thin-font {
		font-size: <?php echo thegem_get_option('counter_thin_font_size_tablet'); ?>px;
	}
}
<?php endif; ?>
<?php if(thegem_get_option('counter_thin_line_height_tablet')) : ?>
@media (max-width: 1199px) {
	.gem-counter-number.thin-font {
		line-height: <?php echo thegem_get_option('counter_thin_line_height_tablet'); ?>px;
	}
}
<?php endif; ?>
<?php if(thegem_get_option('counter_thin_font_size_mobile')) : ?>
@media (max-width: 767px) {
	.gem-counter-number.thin-font {
		font-size: <?php echo thegem_get_option('counter_thin_font_size_mobile'); ?>px;
	}
}
<?php endif; ?>
<?php if(thegem_get_option('counter_thin_line_height_mobile')) : ?>
@media (max-width: 767px) {
	.gem-counter-number.thin-font {
		line-height: <?php echo thegem_get_option('counter_thin_line_height_mobile'); ?>px;
	}
}
<?php endif; ?>
<?php endif; ?>
...
.wpb-js-composer .gem-tta.gem-tta-tabs .gem-tta-tab.gem-active > a,
.wpb-js-composer .gem-tta.gem-tta-tabs.gem-tta-style-outline .gem-tta-tab a,
.wpb-js-composer .gem-tta.gem-tta-tabs.gem-tta-style-modern .gem-tta-tab a,
.wpb-js-composer .gem-tta.gem-tta-tabs .gem-tta-panel.gem-active .gem-tta-panel-title,
.wpb-js-composer .gem-tta.gem-tta-accordion .gem-tta-panel.gem-active .gem-tta-panel-title,
.wpb-js-composer .gem-tta.gem-tta-tabs.gem-tta-style-outline .gem-tta-panel .gem-tta-panel-title,
.wpb-js-composer .gem-tta.gem-tta-accordion.gem-tta-style-outline .gem-tta-panel .gem-tta-panel-title
.wpb-js-composer .gem-tta.gem-tta-tabs .gem-tta-panel.gem-tta-style-modern .gem-tta-panel-title,
.wpb-js-composer .gem-tta.gem-tta-accordion.gem-tta-style-modern .gem-tta-panel .gem-tta-panel-title,
.wpb-js-composer .gem-tta.gem-tta-accordion.gem-tta-style-simple_dashed .gem-tta-panel .gem-tta-panel-title,
.thegem-tabs__nav-item.thegem-tabs__nav-item--active,
.thegem-accordion__item-title.thegem-accordion__item--active,
.portfolio-filter-tabs ul.portfolio-filter-tabs-list li.active {
	font-style: oblique;
...
:root {
	--thegem-to-submenu-highlighter-color: <?php echo thegem_get_option('submenu_highlighter_color'); ?>;
}
...
.widget .gem-latest-news-image a:before {
	<?php if(is_array(hex_to_rgb(thegem_get_option('hover_effect_default_color'), true))) : ?>
...
.blog .gem-simple-gallery .gem-gallery-item a:before {
	<?php if(is_array(hex_to_rgb(thegem_get_option('hover_effect_zooming_blur_color'), true))) : ?>
...
.hover-horizontal-sliding .portfolio-item .gem-simple-gallery .gem-gallery-item a:before {
	<?php if(is_array(hex_to_rgb(thegem_get_option('hover_effect_horizontal_sliding_color'), true))) : ?>
...
.gem-gallery-grid.hover-vertical-sliding .gallery-item .overlay:before {
	<?php if(is_array(hex_to_rgb(thegem_get_option('hover_effect_vertical_sliding_color'), true))) : ?>
