				...
				<div class="portfolio-filters-area-scrollable">
					...
					<div class="widget-area-wrap">
						<div class="page-sidebar widget-area" role="complementary">
							...
							if (($params['filter_by_categories'] == 'yes' || $params['filter_by_categories'] == '1') && count($terms) > 0 && !is_tax('product_tag')) {
								...
								echo $is_dropdown ? ' display-type-dropdown open-dropdown-' . $params['filter_by_categories_display_dropdown_open'] : ''; ?>">
									<?php if ((isset($params['filter_by_categories_show_title']) && ($params['filter_by_categories_show_title'] == 'yes' || $params['filter_by_categories_show_title'] == '1')) || (!$is_dropdown && $params['filters_style'] == 'standard')) { ?>
									...
									<?php if ($is_dropdown) { ?>
										<div class="dropdown-selector">
											<div class="selector-title">
												<?php $title = (!isset($params['filter_by_categories_show_title']) || ($params['filter_by_categories_show_title'] !== 'yes' && $params['filter_by_categories_show_title'] !== '1')) ? $params['filter_by_categories_title'] : str_replace('%ATTR%', $params['filter_by_categories_title'], $params['filters_text_labels_all_text']); ?>
									...
									<?php } ?>
											<?php $filter_by_categories_count = $params['filter_by_categories_count'] == 'yes' || $params['filter_by_categories_count'] == '1';
											$filter_by_categories_hierarchy = $params['filter_by_categories_hierarchy'] == 'yes' || $params['filter_by_categories_hierarchy'] == '1';
											$filter_by_categories_collapsible = $params['filter_by_categories_collapsible'] == 'yes' || $params['filter_by_categories_collapsible'] == '1'; ?>
								...
								foreach ($filter_attr as $index => $item) {
									...
									if (!empty($attribute_data)) {
										...
										<div class="portfolio-filter-item attribute <?php
											...
											<?php if ((isset($item['show_title']) && ($item['show_title'] == 'yes' || $item['show_title'] == '1') && !empty($item['attribute_title'])) || (!$is_dropdown && $params['filters_style'] == 'standard')) { ?>
												<h4 class="name widget-title">
													<span class="widget-title-by">
														<?php echo esc_html($params['filter_buttons_hidden_filter_by_text']); ?>
													</span>
											...
											<?php if ($is_dropdown) { ?>
												<div class="dropdown-selector">
													<div class="selector-title">
														<?php $title = (!isset($item['show_title']) || ($item['show_title'] !== 'yes' && $item['show_title'] !== '')) ? $item['attribute_title'] : str_replace('%ATTR%', $item['attribute_title'], $params['filters_text_labels_all_text']); ?>
														<span class="name" data-title="<?php echo esc_attr($title); ?>">
							...
							if ($params['filter_by_price'] == 'yes' || $params['filter_by_price'] == '1') {
								...
								<div class="portfolio-filter-item price<?php echo $is_dropdown ? ' display-type-dropdown open-dropdown-' . $params['filter_by_price_display_dropdown_open'] : ''; ?>">
									<?php if ((isset($params['filter_by_price_show_title']) && ($params['filter_by_price_show_title'] == 'yes' || $params['filter_by_price_show_title'] == '1')) || (!$is_dropdown && $params['filters_style'] == 'standard')) { ?>
										<h4 class="name widget-title">
											<span class="widget-title-by">
												<?php echo esc_html($params['filter_buttons_hidden_filter_by_text']); ?>
											</span>
									...
									<?php if ($is_dropdown) { ?>
										<div class="dropdown-selector">
											<div class="selector-title">
												<span class="name">
													<?php if (!isset($params['filter_by_price_show_title']) || ($params['filter_by_price_show_title'] !== 'yes' && $params['filter_by_price_show_title'] !== '1')) { ?>
							...
							if ($params['filter_by_status'] == 'yes' || $params['filter_by_status'] == '1') {
								...
								<div class="portfolio-filter-item status multiple<?php echo $is_dropdown ? ' display-type-dropdown open-dropdown-' . $params['filter_by_status_display_dropdown_open'] : ''; ?>">
									<?php if ((isset($params['filter_by_status_show_title']) && ($params['filter_by_status_show_title'] == 'yes' || $params['filter_by_status_show_title'] == '1')) || (!$is_dropdown && $params['filters_style'] == 'standard')) { ?>
										<h4 class="name widget-title">
											<span class="widget-title-by">
												<?php echo esc_html($params['filter_buttons_hidden_filter_by_text']); ?>
											</span>
									...
									<?php if ($is_dropdown) { ?>
										<div class="dropdown-selector">
											<div class="selector-title">
												<?php $title = (!isset($params['filter_by_status_show_title']) || ($params['filter_by_status_show_title'] !== 'yes' && $params['filter_by_status_show_title'] !== '1')) ? $params['filter_by_status_title'] : str_replace('%ATTR%', $params['filter_by_status_title'], $params['filters_text_labels_all_text']); ?>
												<span class="name" data-title="<?php echo esc_attr($title); ?>">
