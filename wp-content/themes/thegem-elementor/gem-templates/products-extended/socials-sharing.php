...
<div class="socials-sharing socials socials-colored-hover ">
	...
	<?php endif; ?>
	<?php if (!isset($params['shares_show_tumblr']) || $params['shares_show_tumblr'] == 'yes'): ?>
        <a class="socials-item" target="_blank"
           href="<?php echo esc_url('http://tumblr.com/widgets/share/tool?canonicalUrl=' . urlencode(get_permalink())); ?>"
           title="Tumblr"><i class="socials-item-icon tumblr"></i></a>
	<?php endif; ?>
	<?php if (!isset($params['shares_show_linkedin']) || $params['shares_show_linkedin'] == 'yes'): ?>
        <a class="socials-item" target="_blank"
	...
	<?php endif; ?>
	<?php if (!isset($params['shares_show_reddit']) || $params['shares_show_reddit'] == 'yes'): ?>
        <a class="socials-item" target="_blank"
